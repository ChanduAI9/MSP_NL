...
from .views import UserRegistrationView,UserLoginView,FinancialDetailsView,home,ForecastedFinancialDetailsView,CalculateMetricsView,DownloadTopCompaniesExcelView,FinancialDataView, FinancialDataScreenerView,CustomUserView,CustomView
...
urlpatterns = [
    ...
    path('custom-user/',CustomUserView.as_view(),name='custom-user-detail'),
    path('custom-user/view',CustomView.as_view(),name='custom'),
]
